...
class NoteRepository(driverFactory: DatabaseDriverFactory) {
    // Menggunakan database yang di-generate otomatis oleh SQLDelight
...
/**
 * Fungsi ekstensi untuk konversi dari database entity ke domain model
 */
